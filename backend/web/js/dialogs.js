...
function getDialogIcon (dialogType) {
  var groupPhoto = '<img src="' + project_base_url + 'images/ava-group.svg" width="30" height="30" class="round">';
  var privatPhoto  = '<img src="' + project_base_url + 'images/ava-single.svg" width="30" height="30" class="round">';
