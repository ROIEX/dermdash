            ...
            <div class="panel-body">
                ...
                if (!empty($treatment->treatmentParams[0]->filledSeverity) || !empty($treatment->treatmentParams[0]->brandProvided) || !empty($treatment->treatmentIntensity)) : ?>
                    ...
                    if ($selected_treatments) {
                        if (in_array($treatment->treatmentParams[0]->id, array_keys($selected_treatments))) {
                            $model->brand_provided_treatments[$treatment->id] = 1;
                        }
...
//
                        ...
                        <?php else : ?>
                            <div class="col-xs-6">
                                ...
                                if($treatment_special) {
                                    if (in_array($param->id, array_keys($treatment_special))) {
                                        $special_value = $treatment_special[$param->id];
                                    }
                                }
